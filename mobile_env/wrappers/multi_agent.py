...
class RLlibMAWrapper(MultiAgentEnv):
    def __init__(self, env):
        ...
        # RLlib expects the action and observation space to be defined per actor (UE)
        ...
        # track UE IDs of last observation's dictionary, i.e., what UEs were active last step
    ...
    def step(self, action_dict: MultiAgentDict) -> Tuple[MultiAgentDict, MultiAgentDict, MultiAgentDict, MultiAgentDict]:
        ...
        dones = {
            ue_id: True if ue_id in dones else False for ue_id in self.prev_step_ues}
        dones['__all__'] = done
